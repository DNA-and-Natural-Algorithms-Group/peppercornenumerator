# -*- coding: utf-8 -*-
#
# Enumerator documentation build configuration file, created by
...
project = u'Peppercorn Enumerator'
copyright = u'2014, Karthik Sarma, Casey Grun, Brian Wolfe, Seung Woo Shin, Erik Winfree'
