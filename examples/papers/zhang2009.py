...
def setups():
    ...
    zhang2009_F3['simulation'] = [
            ('pilsimulator', '--nxy', '--atol', '1e-10', '--rtol', '1e-10', '--t8', '36000', '--t-lin', '10000', '--p0', 'R=3', 'S=1', 'X=0.6'),
            ('pilsimulator', '--nxy', '--atol', '1e-10', '--rtol', '1e-10', '--t8', '36000', '--t-lin', '10000', '--p0', 'R=3', 'S=1', 'X=0.4'),
            ('pilsimulator', '--nxy', '--atol', '1e-10', '--rtol', '1e-10', '--t8', '36000', '--t-lin', '10000', '--p0', 'R=3', 'S=1', 'X=0.2')]
    ...
    zhang2009_F4['simulation'] = [('pilsimulator', '--nxy', '--atol', '1e-10', '--rtol', '1e-10', '--t8', '3600', '--t-lin', '10000', '--p0', 'R=3', 'S=1', 'X=0.4')]
    ...
    zhang2009_F5['simulation'] = [('pilsimulator', '--nxy', '--atol', '1e-12', '--rtol', '1e-12', '--mxstep', '1000', '--t8', '1e6', '--t-lin', '50000', '--p0', 'R=30', 'S=10', 'Z=100', 'X=1')]
