...
def setups():
    ...
    genot2011_F3 = dict()
    genot2011_F3['name'] = 'genot2011_F3'
    genot2011_F3['piltemplate'] = genot2011_F3_pil
    genot2011_F3['pilparams'] = [ (8,7), (17,17), (20,20), (23,23)]
    genot2011_F3['pepperargs'] = {'condensed': False, 'conc': 'nM'}
    genot2011_F3['simulation'] = [('pilsimulator', '--nxy', '--atol', '1e-10', '--rtol', '1e-10', '--t-lin', '10000', '--t8', '1000', '--p0', 'S=6.6', 'I=660')]
    genot2011_F3['reporter'] = 'T'
    genot2011_F3['exp_results'] = [(42, 2.2), (48, 2.2), (100, 2.2), (91, 2.2)] # seconds
    setups.append(genot2011_F3)

    genot2011_F4A = dict()
    genot2011_F4A['name'] = 'genot2011_F4A'
    genot2011_F4A['piltemplate'] = genot2011_F4A_pil
    genot2011_F4A['pilparams'] = [ 11, 9]
    genot2011_F4A['pepperargs'] = {'condensed': False, 'conc': 'nM'}
    ...
    genot2011_F4B = dict()
    genot2011_F4B['name'] = 'genot2011_F4B'
    genot2011_F4B['piltemplate'] = genot2011_F4B_pil
    genot2011_F4B['pilparams'] = [ 11, 9]
    genot2011_F4B['pepperargs'] = {'condensed': False, 'conc': 'nM'}
    ...
    genot2011_F4C = dict()
    genot2011_F4C['name'] = 'genot2011_F4C'
    genot2011_F4C['piltemplate'] = genot2011_F4C_pil
    genot2011_F4C['pilparams'] = [None]
    genot2011_F4C['pepperargs'] = {'condensed': False, 'conc': 'nM'}
    genot2011_F4C['simulation'] = [
            ('pilsimulator', '--nxy', '--p0', 'S=6.6', 'I=330'),
            ('pilsimulator', '--nxy', '--p0', 'S=6.6', 'I=145'),
            ('pilsimulator', '--nxy', '--p0', 'S=6.6', 'I=66')]
    genot2011_F4C['reporter'] = 'T'
    genot2011_F4C['exp_results'] = [(69, 3.3), (177, 3.3), (347, 3.3)]
    setups.append(genot2011_F4C)

    genot2011_F4D = dict()
    genot2011_F4D['name'] = 'genot2011_F4D'
    genot2011_F4D['piltemplate'] = genot2011_F4D_pil
    genot2011_F4D['pilparams'] = [None]
    genot2011_F4D['pepperargs'] = {'condensed': False, 'conc': 'nM'}
    genot2011_F4D['simulation'] = [
            ('pilsimulator', '--nxy', '--atol', '1e-10', '--rtol', '1e-10', '--t-lin', '10000', '--t8', '1000', '--p0', 'S=6.6', 'I=330'),
            ('pilsimulator', '--nxy', '--atol', '1e-10', '--rtol', '1e-10', '--t-lin', '10000', '--t8', '1000', '--p0', 'S=6.6', 'I=145'),
            ('pilsimulator', '--nxy', '--atol', '1e-10', '--rtol', '1e-10', '--t-lin', '10000', '--t8', '1000', '--p0', 'S=6.6', 'I=66')]
    genot2011_F4D['reporter'] = 'T'
    genot2011_F4D['exp_results'] = [(176, 3.3), (213, 3.3), (248, 3.3)]
    setups.append(genot2011_F4D)

    genot2011_SF4A = dict()
    genot2011_SF4A['name'] = 'genot2011_SF4A'
    genot2011_SF4A['piltemplate'] = genot2011_SF4A_pil
    genot2011_SF4A['pilparams'] = [17,20,23]
    genot2011_SF4A['pepperargs'] = {'condensed': False, 'conc': 'nM'}
