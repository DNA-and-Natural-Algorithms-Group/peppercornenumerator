...
class CondenseTests(unittest.TestCase):
    ...
    def testTarjans(self):
        tarjans_reactions = pluck(
            self.reactions, ['A->B', 'B->C', 'C->D', 'D->A', 'D->E'])
        print "Reactions:"
        ...
        reactions_consuming_abcd_e = get_reactions_consuming(
            tarjans_complexes, tarjans_reactions)
    ...
    def testTarjans2(self):
        ...
        assert rsort(tarjans(complexes, reactions,
    ...
    def testCondenseGraph2(self):
        ...
        print "Expected Reactions: "
        expected_reactions = set([ReactionPathway(
            'condensed', [resting_state_A[0], resting_state_A[0]], [resting_state_E[0]])])
