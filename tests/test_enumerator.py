...
#			self.complexes[complex.name] = complex
        ...
        (self.domains2, self.strands2, self.complexes2) = index_parts(
            self.three_arm_enumerator)
...
#			self.complexes2[complex.name] = complex
    ...
    def testSegmentNeighborhood2(self):
        ...
        reaction_set.append(ReactionPathway(
            'branch_3way', [self.complexes['I1']], [self.complexes['I2']]))
        reaction_set.append(ReactionPathway(
            'branch_3way', [self.complexes['I2']], [self.complexes['I1']]))
    ...
    def testEnumeration1(self):
        ...
        new_complex = Complex('C3', [strands['S1'], strands['S2']], [
                              [(1, 0), None], [(0, 0)]])
    ...
    def testEnumeration2(self):
        ...
        exp_resting_complexes = sorted(
            [self.complexes['Cat'], self.complexes['C2'], self.complexes['SP'], self.complexes['I3']])
    ...
    def testEnumeration3(self):
        ...
        reaction_set = []
        reaction_set.append(ReactionPathway(
            'bind21', [c['Cat'], c['C2']], [c['I1']]))
        reaction_set.append(ReactionPathway(
            'open', [c['I1']], [c['Cat'], c['C2']]))
        reaction_set.append(ReactionPathway(
            'branch_3way', [c['I1']], [c['I2']]))
        reaction_set.append(ReactionPathway(
            'branch_3way', [c['I2']], [c['I1']]))
        reaction_set.append(ReactionPathway(
            'open', [c['I2']], [c['SP'], c['I3']]))
        reaction_set.append(ReactionPathway(
            'bind21', [c['SP'], c['I3']], [c['I2']]))
        reaction_set.append(ReactionPathway(
            'bind21', [c['I3'], c['C1']], [c['I4']]))
        reaction_set.append(ReactionPathway(
            'open', [c['I4']], [c['I3'], c['C1']]))
        reaction_set.append(ReactionPathway(
            'branch_3way', [c['I4']], [c['OP'], c['I5']]))
        ...
        reaction_set.append(ReactionPathway(
            'branch_3way', [c['I5']], [c['I6']]))
        reaction_set.append(ReactionPathway(
            'branch_3way', [c['I6']], [c['I5']]))
        reaction_set.append(ReactionPathway(
            'open', [c['I6']], [c['W'], c['Cat']]))
        reaction_set.append(ReactionPathway(
            'bind21', [c['W'], c['Cat']], [c['I6']]))
        ...
        reaction_set.append(ReactionPathway(
            'branch_3way', [c['I4']], [c['I7']]))
        reaction_set.append(ReactionPathway(
            'branch_3way', [c['I7']], [c['I4']]))
        reaction_set.append(ReactionPathway(
        ...
        reaction_set.append(ReactionPathway(
            'open', [c['I7']], [c['I8'], c['Cat']]))
        reaction_set.append(ReactionPathway(
            'branch_3way', [c['I8']], [c['OP'], c['W']]))
...
#		self.tet_enumerator = input_enum('tests/files/examples/sadowski-tetrahedron.enum')
#		self.tet_enumerator.enumerate()

    def testEnumeration4(self):
        self.three_arm_nodal_enum = input_enum(
            'tests/files/examples/3-arm-junction.enum')
        self.three_arm_nodal_enum.enumerate()

    def testEnumeration5(self):
        self.seesaw_enumerator = input_enum(
