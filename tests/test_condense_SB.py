...
from peppercornenumerator.condense import condense_graph, SetOfFates, ReactionGraph
from peppercornenumerator.input import read_kernel
from peppercornenumerator.objects import PepperDomain, PepperComplex, PepperReaction, PepperRestingState, clear_memory
...
class CondenseTests(unittest.TestCase):
    ...
    def test_condense_simple_old(self):
        ...
        # RestingState representation
        rs1 = PepperRestingState([complexes['c1']], name = 'c1', memorycheck=False)
        rs2 = PepperRestingState([complexes['c2']], name = 'c2', memorycheck=False)
        rs3 = PepperRestingState([complexes['c4']], name = 'c4', memorycheck=False)
        rs4 = PepperRestingState([complexes['c5']], name = 'c5', memorycheck=False)

        # Frozensets instead of restingstates
        fs1 = frozenset([complexes['c1']])
        fs2 = frozenset([complexes['c2']])
        fs3 = frozenset([complexes['c4']])
        fs4 = frozenset([complexes['c5']])

        cplx_to_state = { # maps Complex to its RestingState
                complexes['c1'] : rs1,
                complexes['c2'] : rs2,
                complexes['c4'] : rs3, 
                complexes['c5'] : rs4
        ...
        set_to_fate = { # maps frozenset to the RestingState
                fs1 : rs1,
                fs2 : rs2,
                fs3 : rs3,
                fs4 : rs4 }   
        ...
        info = condense_graph(enum, True, enum.k_fast)
        
        self.assertEqual(sorted([rs1, rs2, rs3, rs4]),  sorted(info['resting_states']))
        self.assertDictEqual(set_to_fate, info['resting_state_map'])

        self.assertDictEqual(cplx_to_set,  info['complexes_to_resting_states'])
        self.assertDictEqual(cplx_to_fate, info['resting_state_targets'])

        self.assertEqual([cond_react],     info['condensed_reactions'])
        self.assertEqual(cond_react.rate, info['condensed_reactions'][0].rate)
        self.assertEqual(info['condensed_reactions'][0].rate, 50)
    ...
    def test_condense_simple(self):
        ...
        # RestingState representation
        rs1 = PepperRestingState([complexes['c1']], memorycheck=False)
        rs2 = PepperRestingState([complexes['c2']], memorycheck=False)
        rs3 = PepperRestingState([complexes['c4']], memorycheck=False)
        rs4 = PepperRestingState([complexes['c5']], memorycheck=False)
        ...
        self.assertEqual(sorted([rs1, rs2, rs3, rs4]),  sorted(enumRG.resting_states))
    ...
    def test_cooperative_binding_old(self):
        ...
        # always resting states
        rs1 = PepperRestingState([L], memorycheck=False)
        rs2 = PepperRestingState([C], memorycheck=False)
        rs3 = PepperRestingState([R], memorycheck=False)
        rs4 = PepperRestingState([T], memorycheck=False)
        rs5 = PepperRestingState([LR], memorycheck=False)

        rs6 = PepperRestingState([CR, CRF], memorycheck=False)
        rs7 = PepperRestingState([LC, LCF], memorycheck=False)
        ...
        cr3  = PepperReaction([rs1, rs6], [rs5, rs4], 'condensed', rate=3e6, memorycheck=False)
        cr4  = PepperReaction([rs3, rs7], [rs5, rs4], 'condensed', rate=3e6, memorycheck=False)
        ...
        self.assertEqual(sorted([cr1, cr1r, cr2, cr2r, cr3, cr4]), 
                         sorted(info['condensed_reactions']))
    ...
    def test_fate_example(self):
        ...
        enumRG = ReactionGraph(enum)
        enumRG.condense()
        self.assertEqual(len(enumRG.resting_states), 6)
...
class CondenseCRNs(unittest.TestCase):
    ...
    def rs(self, names):
        return PepperRestingState(map(self.cplx, names), memorycheck=False)
    ...
    def test_CondenseGraphCRN_01(self):
        ...
        self.assertEqual(enumRG.resting_states, [rs('E'), rs('D'), rs('F'), rs('G')])
    ...
    def test_CondenseGraphCRN_03(self):
        ...
        self.assertEqual(sorted(enumRG.resting_states), 
        ...
        #print 'my', enumRG.condensed_reactions
        print
        for r in enumRG.condensed_reactions:
            print "XXXXXXXXXXXXXXXXXXXXXXXXX",r, r.rate

    def test_bugs_var1(self):
        complexes = self.complexes
        reactions = self.reactions
        cplx = self.cplx
        rxn = self.rxn
        ...
        rxn('com2 + bot -> e29', k =     4.5e+06, rtype='open')
        rxn('com2 + com1 -> e1', k =     1.5e+06, rtype='open')
        rxn('e1 -> com2 + com1', k =     21.7122, rtype='open')
        rxn('e1 -> e6 + e7    ', k =     9.52381, rtype='open')
        rxn('e1 -> e8         ', k =     22.2222, rtype='open')
        rxn('e6 + bot -> e31  ', k =     4.5e+06, rtype='open')
        rxn('e7 -> e15        ', k =     22.2222, rtype='open')
        rxn('e8 -> e1         ', k =     22.2222, rtype='open')
        rxn('e8 -> e6 + e15   ', k =     9.52381, rtype='open')
        rxn('e8 -> e11 + e10  ', k =     21.7122, rtype='open')
        rxn('e10 -> e6 + e17  ', k =     9.52381, rtype='open')
        rxn('e11 + e17 -> e15 ', k =     1.5e+06, rtype='open')
        rxn('e15 -> e7        ', k =     22.2222, rtype='open')
        rxn('e15 -> e11 + e17 ', k =     21.7122, rtype='open')
        rxn('e29 + com1 -> e33', k =     1.5e+06, rtype='open')
        rxn('e33 -> e29 + com1', k =     21.7122, rtype='open')
        rxn('e33 -> e37       ', k =     22.2222, rtype='open')
        rxn('e33 -> e38       ', k = 0.000623053, rtype='open')
        rxn('e37 -> e11 + e58 ', k =     21.7122, rtype='open')
        rxn('e37 -> e33       ', k =     22.2222, rtype='open')
        rxn('e37 -> e43       ', k = 0.000623053, rtype='open')
        rxn('e38 -> e7 + e31  ', k =     16.6667, rtype='open')
        rxn('e38 -> e33       ', k = 0.000623053, rtype='open')
        rxn('e38 -> e43       ', k =     22.2222, rtype='open')
        rxn('e43 -> e11 + e47 ', k =     21.7122, rtype='open')
        rxn('e43 -> e31 + e15 ', k =     16.6667, rtype='open')
        rxn('e43 -> e37       ', k = 0.000623053, rtype='open')
        rxn('e43 -> e38       ', k =     22.2222, rtype='open')
        rxn('e47 -> e17 + e31 ', k =     16.6667, rtype='open')
        rxn('e47 -> e58       ', k = 0.000623053, rtype='open')
        rxn('e58 -> e47       ', k = 0.000623053, rtype='open')
        rxn('top + bot -> e27 ', k =     4.5e+06, rtype='open')
    ...
    def test_bugs_var2(self):
        ...
        rxn('e1 -> com2 + com1', k =     21.7122, rtype='open')
        rxn('e1 -> e6 + e7    ', k =     9.52381, rtype='open')
        rxn('e1 -> i8         ', k =     22.2222, rtype='open')
        rxn('e6 + bot -> e31  ', k =     4.5e+06, rtype='open')
        rxn('e7 -> e15        ', k =     22.2222, rtype='open')
        rxn('i8 -> e1         ', k =     22.2222, rtype='open')
        rxn('i8 -> e6 + e15   ', k =     9.52381, rtype='open')
        rxn('i8 -> e11 + e10  ', k =     21.7122, rtype='open')
        rxn('e10 -> e6 + e17  ', k =     9.52381, rtype='open')
        rxn('e11 + e17 -> e15 ', k =     1.5e+06, rtype='open')
        rxn('e15 -> e7        ', k =     22.2222, rtype='open')
        rxn('e15 -> e11 + e17 ', k =     21.7122, rtype='open')
