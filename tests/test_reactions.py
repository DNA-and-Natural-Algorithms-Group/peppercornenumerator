...
def assert_reaction(reactants, move, product_sets):
    ...
    for products in product_sets:
        ...
        expected_rxns += [ReactionPathway(move.__name__,
                                          rcomplexes, pcomplexes)]
...
class OpenTests(unittest.TestCase):
    ...
    def testSplitComplex1(self):
        ...
        bs_complex = Complex('BS', [self.strands['BS']], [
    ...
    def testFindReleases5(self):
        ...
        exp_list = [self.complexes['C1'], self.complexes['Cat'], Complex(
            'BS', [self.strands['BS']], [[None, None, None, None, None, None]])]
    ...
    def testOpen2(self):
        ...
        complex = Complex('t1', [self.strands['PS'], self.strands['BS']], [
    ...
    def testOpen6(self):
        ...
        res_list = open(complex)
        exp_list = [ReactionPathway(
            'open', [complex], [Complex('B', [strand], [[None, None, None]])])]
    ...
    def testOpen7(self):
        ...
        res_list = open(complex)
        exp_list = [ReactionPathway('open', [complex], sorted([Complex('C1', [S3], [
                                    [None, None]]), Complex('C2', [S1, S2], [[None, (1, 0)], [(0, 1)]])]))]
        assert res_list == exp_list
...
class Branch3WayTests(unittest.TestCase):
    ...
    def testDo3wayMigration2(self):
        ...
        #  Cat
        #  ___
        res_list = do_3way_migration(
            complex, (complex.strand_index('PS'), 4), (complex.strand_index('BS'), 1))
    ...
    def testBranch3way2(self):
        ...
        exp_list = [ReactionPathway('branch_3way', [self.complexes['I1']], [
                                    self.complexes['I2']])]
    ...
    def testBranch3way4(self):
        ...
        exp_rxn = ReactionPathway('branch_3way', [self.complexes['IABC']], [
                                  self.complexes['I'], self.complexes['ABC']])
        print res_list
        print_products(res_list)
        ...
        assert sorted([[prod.dot_paren_string() for prod in r.products]
                       for r in res_list]) == sorted(structs_list)
    ...
    def testBranch3wayA(self):
        ...
        assert forward == [ReactionPathway(
            'branch_3way', [complexes['A1']], [complexes['A2']])]

        reverse = branch_3way(complexes['A2'])
        print "<- : ", reverse
        print_products(reverse)
        assert reverse == [ReactionPathway(
...
class Branch4WayTests(unittest.TestCase):
    ...
    def testBranch4wayA(self):
        ...
        print_products(forward)
        assert forward == [ReactionPathway(
            'branch_4way', [complexes['A1']], [complexes['A2']])]
...
class ReactionPathwayTests(unittest.TestCase):
    ...
    def testEq(self):
        rp1 = ReactionPathway('branch_3way', [self.complexes['C1']], [
                              self.complexes['C2']])
        ...
        rp6 = ReactionPathway('branch_3way', [self.complexes['C1']], [
                              self.complexes['Cat']])
    ...
    def testCmp(self):
        ...
        assert cmp(rp1, rp5) == cmp(
            [self.complexes['C1']], [self.complexes['Cat']])
        assert cmp(rp1, rp6) == cmp(
            [self.complexes['C2']], [self.complexes['Cat']])

    def testNormalize(self):
        rp1 = ReactionPathway('branch_3way', [self.complexes['C1']], [
                              self.complexes['C2']])
        rp2 = ReactionPathway('branch_3way', [self.complexes['C1']], [
                              self.complexes['C2']])
        rp2.normalize()
