...
class Enumerator(object):
    ...
    def dry_run(self):
        ...
        self._resting_states = [RestingState(
...
def main():
    ...
    if cl_opts.dry_run:
        ...
        if cl_opts.interactive:
            logging.info()
            logging.info(
                "Interactive mode enabled: fast and slow reactions will be printed for each ")
            logging.info(
                "complex as enumerated. Press ^C at any time to terminate and write accumulated ")
